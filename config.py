...
# Регистрация кланов (отдельные тикеты; если не заданы в .env — наследуются из тикетов)
CLAN_TICKET_CATEGORY = _int("CLAN_TICKET_CATEGORY")
CLAN_TICKET_STAFF_ROLES = _ints("CLAN_TICKET_STAFF_ROLES")
CLAN_TICKET_LOG_CHANNEL = _int("CLAN_TICKET_LOG_CHANNEL")
CLAN_TICKET_TRANSCRIPT_CHANNEL = _int("CLAN_TICKET_TRANSCRIPT_CHANNEL")
if not CLAN_TICKET_CATEGORY:
    CLAN_TICKET_CATEGORY = TICKET_CATEGORY
if not CLAN_TICKET_STAFF_ROLES:
    CLAN_TICKET_STAFF_ROLES = TICKET_STAFF_ROLES
if not CLAN_TICKET_LOG_CHANNEL:
    CLAN_TICKET_LOG_CHANNEL = TICKET_LOG_CHANNEL
if not CLAN_TICKET_TRANSCRIPT_CHANNEL:
    CLAN_TICKET_TRANSCRIPT_CHANNEL = TICKET_TRANSCRIPT_CHANNEL
